...
try {
	print_r($client->sendByTimeZone("TestMC","79296670751","Hi!","2014-03-25T13:56:15"));
} catch( SMSError_Exception $e ) {
	print_r($e);
}
echo "<hr>";
...
try {
	print_r($client->sendBulk("TestMC",array("79296670751","79296670751"),"Hi2!","2014-03-25T13:56:15"));
} catch( SMSError_Exception $e ) {
	print_r($e);
}
